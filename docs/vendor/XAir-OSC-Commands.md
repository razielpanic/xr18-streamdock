...
| /bus/1/mix/pan | f | 0.0-1.0 | -∞ - +10 | Mixbus pan level |
...
| /ch/01/dyn/det | i | 0-1 | PEAK, RMS | Channel compressor |
...
| /ch/01/dyn/thr | f | 0.0-1.0 | -60.0 - 0.0 | Channel compressor threshold (db) |
...
| /ch/01/mix/01/level | f | 0.0-1.0 | -∞ - +10 | Channel mixbus sends level |
...
| /ch/01/mix/fader | f | 0.0-1.0 | -∞ - +10 | Channel fader level |
...
| /config/solo/level | f | 0.0-1.0 | -∞ - +10.0 | Headphone volume level |
...
| /dca/1/fader | f | 0.0-1.0 | -∞ - +10 | DCA fader level |
...
| /fxsend/1/mix/fader | f | 0.0-1.0 | -∞ - +10 | Fx send fader level |
...
| /lr/mix/fader | f | 0.0-1.0 | -∞ - +10 | Main LR fader level |
...
| /rtn/1/mix/01/level | f | 0.0-1.0 | -∞ - +10 | Fx Return [1..4] mixbus sends level |
...
| /rtn/1/mix/fader | f | 0.0-1.0 | -∞ - +10 | Fx Return [1..4] fader level |
...
| /rtn/aux/mix/01/level | f | 0.0-1.0 | -∞ - +10 | Aux Return mixbus sends level |
...
| /rtn/aux/mix/fader | f | 0.0-1.0 | -∞ - +10 | Aux Return fader level |
